...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $mailer->setFrom('Administracion@Medifinder.com');
        $mailer->addAddress('cuenta@Medifinder.com','Medifinder.com');
        ...
        $contenido = "<html>";
        $contenido .="<p> <strong> hola ". $this->nombre."</strong> has creado tu cuenta en Medifinder</p>";
